...
Строю fullstack-приложения под ключ — React/Next.js на фронте, Node/Express на бэкенде, PostgreSQL и real-time через WebSocket. Сейчас веду **WorkChat** — платформу для учебных групп с чатом, ролями и админкой, live на [https://www.elbrus-chat.ru](https://www.elbrus-chat.ru)]((/)).
